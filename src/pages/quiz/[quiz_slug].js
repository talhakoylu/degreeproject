                ...
                <ContainerArea>
                    <Stack direction={{ base: "column-reverse", md: "row" }} marginTop={8} spacing={4} align={"start"}>
                        ...
                        <VStack width={{ base: "100%", md: "25%" }} align={"flex-start"} >
                            ...
                            <SidebarBox title={"Bir Oyun Oluştur"} description={"Bu sınava ait sorulardan oluşan bir oyun oluşturabilirsiniz."} buttonOnClick={() => router.push({pathname: "/quiz/game/create-game", query: {quiz_id: data._id}})} buttonText={"Oyun Oluştur"} icon={<VscDebugStart />} />
